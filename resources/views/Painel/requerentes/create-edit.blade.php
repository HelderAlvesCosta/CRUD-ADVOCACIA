...
<h1 class="title-pg" align="center">
    <a href="{{route('requerentes.index')}}" > <span class='glyphicon glyphicon-fast-backward'> </a>
    Gestão Requerente: <font style="color:red;" size="3"> <b>{{$requerente->nome or  '<Novo>'}}</b> </font>
</h1>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><font style="color:red;" size="3"> <b>Dados do Requerente</b> </font></div>
