                          ...
                          <div class="panel-body">
                                <form  class="form-horizontal" role="form">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                      <select id="nacionalidade" name="nacionalidade" data-placeholder="Your Favorite Types of Bear" class="chosen-select-width" tabindex="15">
                                          <option></option>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                      <select  id="estado_civil" name="estado_civil" data-placeholder="Your Favorite Types of Bear" class="chosen-select-width" tabindex="15">
                                      <option></option>
                               ...
                               <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                          <input id="cep" name="cep" type="text" class="form-control cep" name="cep" value="{{$requerente->cep or old('cep')}}" required>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-6">
                                      @if( isset($requerente) ) 
                                          <input type="email" id="email" class="form-control" value="{{$requerente->email or old('email')}}" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                                      @else
                                          <input type="email" id="email" class="form-control" value="default@example.com" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                                      @endif
                                  ...
                                  <div class="form-group">
                                      <div class="col-md-8 col-md-offset-4">
                                          <button type="button" class="btn btn-primary add_requerente">
                                              Enviar
                                          </button>
                                      </div>
                                  </div>
