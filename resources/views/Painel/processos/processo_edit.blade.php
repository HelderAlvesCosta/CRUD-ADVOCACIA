    ...
    Gestão Processo: <font style="color:red;" size="3">  {{$processo->numero or '<Novo>'}}</font>
</h1>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                          ...
                          <!--  <select name='cod_requerente' class='form-control'> -->
                                 <select id="requerente_sel" name="requerente_sel" data-placeholder="Selecione o Requerente" class="chosen-select-width" tabindex="15">
                                    <option></option>    
...
<!-- Requerente fim -->
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="advogado_sel" name="advogado_sel"  data-placeholder="Selecione o Advogado" class="chosen-select-width form-control" tabindex="15">
                                  <option> </option>
                                ...
                                <div class="col-md-8 col-md-offset-1">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <!-- INICIO SELECTED -->
                                                <div class="form-group">
                                                    <label for="numero" class="col-md-4 control-label">Lesôes</label>

                                                      <div class="col-md-6">
                                                        <select data-placeholder="Selecionar lesões" multiple class="chosen-select" tabindex="8">
